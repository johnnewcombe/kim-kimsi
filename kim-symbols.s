...
; Application I/O
; PB6 is used as a chip select ? (User Manual p.H3)
;SAD         = $1700             ; 6530-003 A DATA
;PADD        = $1701             ; 6530-003 A DATA DIRECTION (0=input 1=output)
;PBD         = $1702             ; 6530-003 B DATA
;PBDD        = $1703             ; 6530-003 B DATA DIRECTION

; System I/O (Used for Display and Keyboard)
; PB6 is used as a chip select ? (User Manual p.H3)
SAD         = $1740             ; 6530-002 A DATA
PADD        = $1741             ; 6530-003 A DATA DIRECTION  (0=input 1=output)
SBD         = $1742             ; 6530-003 B DATA
PBDD        = $1743             ; 6530-003 B DATA DIRECTION
; Timer
...
ID          = $17F9             ; TAPE PROGRAM ID NUMBER
    ...
    ;       INTERRUPT VECTORS (indirect jmps from FFFA/C/E respectively)
